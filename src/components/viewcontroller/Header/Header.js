...
class HeaderView extends React.Component {
    ...
    render() {
        ...
        if (this.props.callFrom === "Success") {
            return (
                <View style={{paddingLeft:10, flexDirection: 'row', backgroundColor: '#595278',paddingTop:Platform.OS === 'ios' ? 60 : 5 ,alignItems:'center',justifyContent:'center'}}>
                    <TouchableOpacity onPress= {() => this.props.context.menuItemPressed()} style={{flexDirection:'row',paddingBottom:10,
                    ...
                    <View style={{ flex: 0.2, flexDirection: 'row', justifyContent: 'flex-end', marginRight: 10}}>
            ...
            return (
                <View style={{paddingLeft:10, flexDirection: 'row', backgroundColor: '#595278',paddingTop:Platform.OS === 'ios' ? 60 : 5 ,alignItems:'center',justifyContent:'center'}}>
                    <TouchableOpacity onPress= {() => this.props.context.menuItemPressed()} style={{flexDirection:'row',paddingBottom:10,flex:1,
                        alignContent: 'center', justifyContent: 'center',}}>
                             <Image  source={require('../../../ImageAssets/backbtn.png')} >
          </Image>  
                        </TouchableOpacity>
                    
                    <View style={{ flex: 5, marginLeft:30,alignContent: 'center', justifyContent: 'center', }}>
        ...
        else
        {
            ...
            return (
                ...
                <View style={{ flexDirection: 'row', backgroundColor: '#595278' ,paddingTop:Platform.OS === 'ios' ? 60 : 5}}>
                    ...
                    <View style={{ flex: 2.2, flexDirection: 'row', justifyContent: 'flex-end', marginRight: 10, marginTop: 10 }}>
                        <TouchableOpacity onPress={() => this.props.context.pressNotification()}>
                            <IconBadge
                                MainElement={
                                    // <View  style={{
