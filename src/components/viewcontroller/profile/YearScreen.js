...
export default class YearScreen extends React.Component {
    ...
    updateData(monthdate) {
       ...
       this.setState({ month: monthdate,monthDate:startDate});
        var attendence = { staffid: this.state.profileDataSurce._staffid, month_year: month_year,year:monthdate+"" };
        this.WebServicesManager.postApiHoursHistoryYear({ dataToInsert: attendence, apiEndPoint: "get_hours_history_wm" },
            (statusCode, response) => {
    ...
    Next() {
        ...
        var nextDate = moment(this.state.monthDate, 'YYYY-MM-DD hh:mm:ss').add(1, 'y');
        var nextMonth = moment(this.state.monthDate, 'YYYY-MM-DD hh:mm:ss').add(1, "y").format("YYYY");
        this.setState({ month: nextMonth, monthDate: nextDate });
        this.updateData(nextMonth);
    }

    Prev() {
        var prevDate = moment(this.state.monthDate, 'YYYY-MM-DD hh:mm:ss').subtract(1, 'y');
        var prevMonth = moment(this.state.monthDate, 'YYYY-MM-DD hh:mm:ss').subtract(1, "y").format("YYYY");
            ...
            <Container>
                ...
                <ImageBackground source={require('../../../ImageAssets/background.png')}
                    ...
                    <View style={{ backgroundColor: '#595278', flexDirection: 'row' }}>
                        ...
                        <Button onPress={() => this.props.navigation.navigate("MonthScreen")} style={{ flex: 1, justifyContent: 'center', backgroundColor: constants.colorPurpleLight595278, opacity: 0.4, }}>
                            <Text style={{ color: constants.colorWhitefcfcfc }}>By Month</Text>
                        </Button>
                        <Button onPress={() => this.props.navigation.navigate("YearScreen")} style={{ flex: 1, justifyContent: 'center', backgroundColor: constants.colorPurpleDark302757, opacity: 0.4, }}>
                    ...
                    <View style={{  flexDirection: 'row', backgroundColor: '#595278', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <TouchableOpacity onPress={() => this.props.navigation.navigate("SelectYearScreen", { context: this })}>
