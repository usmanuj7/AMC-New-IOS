...
export default class ReportScreen extends React.Component {
    ...
    (statusCode,weeknumber, response) => {
        if (Utilities.checkAPICallStatus(statusCode)) {
         ...
         var fridayhrs= response.hours_history_weekly[friday]
              ...
              var arrayTopush=[];
              var inHrs=moment.duration(parseInt(moment.duration(sundayhrs.break).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              var inHrs=moment.duration(parseInt(moment.duration(sundayhrs.worked).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              ...
              var arrayTopush=[];
              var inHrs=moment.duration(parseInt(moment.duration(mondayhrs.break).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              var inHrs=moment.duration(parseInt(moment.duration(mondayhrs.worked).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              ...
              var arrayTopush=[];
              var inHrs=moment.duration(parseInt(moment.duration(tuesdayhrs.break).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              var inHrs=moment.duration(parseInt(moment.duration(tuesdayhrs.worked).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              // arrayTopush.push(parseInt(tuesdayhrs.total.split(":")[0]))
              var arrayToSend=this.state.arrayToSend;
              arrayToSend.push(arrayTopush);
              this.setState({arrayToSend:arrayToSend});

              var arrayTopush=[];
              var inHrs=moment.duration(parseInt(moment.duration(wednesdayhrs.break).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              var inHrs=moment.duration(parseInt(moment.duration(wednesdayhrs.worked).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              // arrayTopush.push(parseInt(wednesdayhrs.total.split(":")[0]))
              var arrayToSend=this.state.arrayToSend;
              arrayToSend.push(arrayTopush);
              this.setState({arrayToSend:arrayToSend});

              var arrayTopush=[];
              var inHrs=moment.duration(parseInt(moment.duration(thursdayhrs.break).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              var inHrs=moment.duration(parseInt(moment.duration(thursdayhrs.worked).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              // arrayTopush.push(parseInt(thursdayhrs.total.split(":")[0]))
              var arrayToSend=this.state.arrayToSend;
              arrayToSend.push(arrayTopush);
              this.setState({arrayToSend:arrayToSend});

              var arrayTopush=[];
              var inHrs=moment.duration(parseInt(moment.duration(fridayhrs.break).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              var inHrs=moment.duration(parseInt(moment.duration(fridayhrs.worked).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              // arrayTopush.push(parseInt(fridayhrs.total.split(":")[0]))
              var arrayToSend=this.state.arrayToSend;
              arrayToSend.push(arrayTopush);
              this.setState({arrayToSend:arrayToSend});

              var arrayTopush=[];
              var inHrs=moment.duration(parseInt(moment.duration(saturdayhrs.break).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              var inHrs=moment.duration(parseInt(moment.duration(saturdayhrs.worked).asMinutes()), "minutes").format({ template: "h", precision: 2 });
              arrayTopush.push(parseFloat(inHrs));
              // arrayTopush.push(parseInt(saturdayhrs.total.split(":")[0]))
              var arrayToSend=this.state.arrayToSend;
              arrayToSend.push(arrayTopush);
              this.setState({arrayToSend:arrayToSend});
    ...
    Next() {
        ...
        this.setState({ weekToCheck:nextWeek});
        }
